          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-4">
            ...
            <div className="p-6 bg-white   flex flex-col items-center justify-start text-center corner-class">
              ...
              <p className=" text-gray-700 text-start mx-8 mb-8">
                <ul className="list-disc">
                  <li>
                    Сертифікована доула смерті. • Блогерка, займаюсь просвітою у
                    темі смерті, горя, підтримки. • Знімаю табу з тем, про які
                    мовчать. • Працюю з темами: страх смерті, горювання,
                    підтримка під час проживання втрат, та інші.
                  </li>
                  <li>
                    На цьому майстер-класі я пропоную вам подивитись на своє
                    життя через призму смерті. Кому може бути цікавий та
                    корисний майстер-клас? • тим, хто любить досліджувати себе
                    та своє життя, шукати і знаходити нові сенси та цінності, •
                    тим, кому цікава тема смерті, • тим, в кого є страх смерті і
                    готовність/ресурс/бажання познайомитись із цим страхом
                    ближче, • тим, хто відчуває конфронтацію із фактом людської
                    смертності.
                  </li>
                </ul>
              </p>
            ...
            <div className="p-6 bg-white   flex flex-col items-center justify-start text-center corner-class">
              ...
              <p className=" text-gray-700 text-start mx-8 mb-8">
                <ul className="list-disc">
                  ...
                  <li>
                    Духовні істини вічні, але їх форми змінюються залежно від
                    часу, місця та нашої готовності. Перебуваючи у церкві або в
                    індійському ашрамі, ми отримуємо настанови й рекомендації.
                    Та чи завжди у нас є розуміння, як це застосовувати у
                    повсякденному житті. Чи є живий приклад відповідний
                    сучасності на який ми можемо орієнтуватись? Вчителi
                    закликають відмовитись вiд матерiального, проте як бути тим
                    хто має обов'язки перед своїми близькими - дiтьми та
                    батьками. Невже турбота про благополуччя ближніх своїх має
                    таку малу ціну. Нам кажуть любити забувши про себе, але дуже
                    часто люди вигорають віддавшись такій любові. Як тоді
                    зберегти баланс ?
                  </li>
                  <li>
            ...
            <div className="p-6 bg-white   flex flex-col items-center justify-start text-center corner-class">
              ...
              <p className=" text-gray-700 text-start mx-8 mb-8">
                <ul className="list-disc">
                  ...
                  <li>
                    Про що взаємодія і зустрічі з Яною: - як поєднуються
                    енергія, психіка і тіло (психосоматика, йога і методи
                    впливу) - як функціонує енергія в єдиній системі, як
                    накопичувати і наповнювати ресурс - як зцілити всі сфери
                    життя і вийти з обмежуючих упереджень - як відчувати себе
                    присутньою і щасливою в моменті зараз - як бути цілісною вже
                    зараз
                  </li>
                </ul>
              </p>
              ...
              <p className=" text-gray-700 text-start mx-8 mb-8">
                <ul className="list-disc">
                  ...
                  <li>
                    ...
                    перестати жити в 0, мати заощадження - почати працювати
                    менше, легше і з задоволенням - позбутись обмежень, що
                    гальмують фінансове зростання - зрозуміти які саме дії
                    потрібно зробити на шляху до фінансової мети - отримати
                    мотивацію до дій і їх перелік
                  </li>
                  <li>
